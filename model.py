...
class myClassifier(nn.Module):
    def __init__(self, in_channel=3, attr_channel=37):
        ...
        #self.pool = nn.AdaptiveAvgPool2d(37)
        self.head_01 = nn.Linear(256*4*4, 37*4*4,True)
        self.head_1 = nn.Linear(37*4*4, attr_channel, True)
...
class myDecoder(nn.Module):
	def __init__(self, inchannel=3, num_classes=1):
		super(myDecoder,self).__init__()
		self.layer1 = SingleConv(inchannel,64,1)
		self.layer2 = nn.Sequential(myResidualBlock(64,64,1), myResidualBlock(64,64,2))
		self.layer3 = nn.Sequential(myResidualBlock(64,64,1), myResidualBlock(64,64,2))
		self.layer4 = nn.Sequential(myResidualBlock(64,64,1), myResidualBlock(64,64,2))
		self.layer5 = nn.Sequential(myResidualBlock(64,64,1), myResidualBlock(64,64,2))
